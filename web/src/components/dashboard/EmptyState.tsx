...
export function EmptyState({ message = "Esperando la primera señal del sistema..." }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full min-h-[400px] bg-white dark:bg-[#131722] rounded-lg border border-gray-200 dark:border-gray-800 p-8">
      ...
      <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-2">Sistema en modo de espera</h3>
      <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
        {message}
      </p>
      <div className="mt-8 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-500 bg-gray-100 dark:bg-gray-900/50 px-3 py-1.5 rounded-full border border-gray-200 dark:border-gray-800">
