...
export function InstrumentSelector({
  ...
  return (
    <div className="relative w-full md:w-auto" ref={containerRef}>
      ...
      {/* Desktop Dropdown */}
      <div className={cn(
        "hidden md:block absolute top-full left-0 mt-1 w-48 bg-white dark:bg-[#1a1f2e] border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-50 overflow-hidden transition-all origin-top",
      ...
      <div className={cn(
        "md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1f2e] border-t border-gray-200 dark:border-gray-800 rounded-t-xl z-50 transition-transform duration-300 max-h-[80vh] overflow-hidden flex flex-col",
