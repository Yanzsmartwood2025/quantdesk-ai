...
export function ReasoningFeed({ traces, isPaused }: ReasoningFeedProps) {
  ...
  return (
    <div className={cn(
      "flex flex-col bg-white dark:bg-[#131722] rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden",
      isCollapsed ? "h-auto" : "h-full"
    )}>
      <button
        onClick={() => setIsCollapsed(!isCollapsed)}
        className="px-4 py-3 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#1a1f2e] hover:bg-gray-100 dark:hover:bg-[#22283a] transition-colors w-full flex items-center justify-between group"
      >
